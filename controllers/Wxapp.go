...
// @Tags Wxapp
// @Summary 小程序获取HostSign
// @Param	body			body	Wxapp.Verifyplugin	 true		""
// @Failure 200
// @router /Verifyplugin [post]
func (c *WxappController) Verifyplugin() {
	var Data Wxapp.JSOperateWxParam
	err := json.Unmarshal(c.Ctx.Input.RequestBody, &Data)
	if err != nil {
		Result := models.ResponseResult{
	...
	WXDATA := Wxapp.Verifyplugin(Data)
	c.Data["json"] = &WXDATA
	c.ServeJSON()
}
...
// @Tags 支付模块
// @Summary 云闪付支付
// @Param data body TenPay.UnionpayData true "支付请求数据"
// @Success 200
// @router /GetUnionPay [POST]
func (c *WxappController) GetUnionPay() {
	var Data Wxapp.UnionpayData
	err := json.Unmarshal(c.Ctx.Input.RequestBody, &Data)
	if err != nil {
		Result := models.ResponseResult{
			Code:    -8,
