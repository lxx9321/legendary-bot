...
func SoftType_iPad2(DeviceId string) string {
	...
	return "<softtype><k3>18.8</k3><k9>iPad Air (第7代)</k9><k10>3</k10><k19>" + uuid1 + "</k19><k20>" + uuid2 + "</k20><k22>(null)</k22><k33>微信</k33><k47>1</k47><k50>1</k50><k51>com.tencent.xin</k51><k54>iPad14,4</k54><k61>2</k61></softtype>"
}
func SoftType_iPad(DeviceId string, osVersion string, RomModel string) string {
	uuid1, uuid2 := IOSUuid(DeviceId)
	return "<softtype><k3>" + osVersion + "</k3><k9>iPad Air (第7代)</k9><k10>6</k10><k19>" + uuid1 + "</k19><k20>" + uuid2 + "</k20><k22>(null)</k22><k33>微信</k33><k47>1</k47><k50>1</k50><k51>com.tencent.xin</k51><k54>" + RomModel + "</k54><k61>2</k61></softtype>"
}
